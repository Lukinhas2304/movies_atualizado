    ...
    <ScrollView style={styles.scrollcont}>
      <View style={styles.container}>
        ...
        <View style={{ width: "90%", height: "300%" }}>
          <Text style={styles.textBanner1}> MAIS AVALIADOS </Text>
          <FlatList
          ...
          />
          <Text style={styles.textBanner}> POPULARES </Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal={true}
            data={moviesPopular}
          ...
          />
          <Text style={styles.textBanner}> EM BREVE </Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal={true}
            data={moviesEmBreve}
          ...
          />
          <Text style={styles.textBanner2}> EM CARTAZ </Text>
          <FlatList
            showsHorizontalScrollIndicator={false}
            horizontal={true}
            data={moviesCartaz}
